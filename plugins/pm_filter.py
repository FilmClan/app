...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        btn.insert(0,
            [
                InlineKeyboardButton("Updates", url="https://t.me/SRBBots"),
            ]
        )
        btn.insert(1,
            [
                InlineKeyboardButton("🍿 YouTube Channel 🍿", url="https://youtube.com/@SRBBots"),
            ]
        )
        btn.append(
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('💝 Subscribe YouTube Channel 💗', url=f'https://youtube.com/@SRBBots')
            ],[
            InlineKeyboardButton('♻️ Update Channel ♻️', url=f'https://t.me/SRBBots')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton("Update Channel", url="https://t.me/SRBBots"),
        ]
    )
    btn.insert(1,
        [
